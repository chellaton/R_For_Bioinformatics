...
GC_window_plot <- function(size, sequence, title) {
  ...
  plot(x=x_values, y=y_values, type="b", col='steelblue2',
       main=paste('GC plot for ',title), 
       ylab='GC fraction',
       xlab='genome sequence position')
}
GC_window_plot(200, dengue_seq, 'Dengue virus with 200 intervals')
```
...
leprae_seq <- leprae[[1]]
GC_window_plot(20000, leprae_seq, 'Mycobacterium leprae with 20000 intervals')
```
...
GC_window_plot(200, dengue_seq, 
               'Dengue virus with 200 interval')
